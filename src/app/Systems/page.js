...
export default function SystemsPage() {
  ...
  const imageClasses = "w-full h-[250px] object-cover rounded-lg shadow-lg";
      ...
      case "artificial-turf":
        return (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-700 mb-4">
              Synthetic turf systems are designed from the ground up for safety.
              With our PolyGreen padding, antimicrobial infill and other safety
              features, these systems have been used to successfully surface
              millions of square feet of commercial playgrounds. If you want the
              peace of mind of going with a proven system, playground turf for
              your backyard.
            </p>
      ...
      case "bonded-rubber-mulch":
        return (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-700 mb-4">
              Bonded Rubber Mulch is a spectacular choice that seamlessly blends
              into natural settings while providing unmatched safety. Its
              versatility allows it to be easily combined with EPDM product
              inlays, extending design possibilities and enhancing the overall
              aesthetic appeal of any space.
            </p>
            <p className="text-gray-700 mb-4">
              One of the key characteristics of Bonded Rubber Mulch is its
              ability to accommodate piling and sloping, creating a natural
              ground setting that deceives passersby until they step onto the
              surface and experience its anti-fatigue qualities with each step.
            </p>
            <p className="text-gray-700 mb-4">
              At JC Safety Surfacing, we take safety seriously. Our Bonded
      ...
      case "critical-fall-heights":
        return (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-700 mb-4">
              JC Safety Surfacing specializes in the professional installation
              of equipment for playgrounds, fitness areas, and indoor/outdoor
              recreational spaces. Our team ensures the proper and safe setup of
              all equipment and high-quality surfacing to meet industry
              standards and provide a secure environment for users of all ages.
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-4">
